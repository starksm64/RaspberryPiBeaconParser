...
A run that has seven scanners in five rooms. Rooms 202 and 206 have entry and exit scanners in their doorways. Room202x is the scanner outside, Room202 inside. Similarly, Room206x is outside while Room206 is inside. Rooms 203, 201 and 204 have a scanner near the entryway of the room.

This run has over 1.2M beacon events and spans a little over an hour. The most interesting beacon to view is the one with minor value 130. This is the beacon that was in my pocket as I moved the groups of beacons throughout the rooms.
