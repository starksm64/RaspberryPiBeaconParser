...
public class UploadScannerConfig {
    ...
    public static final String DEFAULT_DYNAMIC_CONFIG_QUEUE = "beaconScannerDynamicConfig";
    public static final String DEFAULT_BROKER_URL = "amqp://184.72.167.147:5672?transport.tcpKeepAlive=true";
    public static final String USER = "demo-user";
    public static final String PASSWORD = "2015-summit-user";
